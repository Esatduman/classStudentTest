...
*/
#include <iostream>
#include "h11_classStudent_e_duman.h" 
...
int main()
{
	...
	*/
	...
	cout << ">>> Create a foreign student fs with name \"Shelley Lin\" \n\n";
	ForeignStudent fs("Lin", "Shelly", "");

	cout << "Print fs by fs.printInfo():\n";
	fs.printInfo();
	...
	cout << "Print fs by fs.printInfo() to access ForeignStudent::printInfo(),\n";
	fs.printInfo();
